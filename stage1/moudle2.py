...
class ResNetC1(nn.Module):
    ...
    def __init__(self, classes):
        ...
        self.level1_1 = CBR(16, 64, 3, 1)
        self.p01 = PSPDec(128, 16, 160, 192)
        self.p02 = PSPDec(128, 16, 128, 192)
        self.p03 = PSPDec(128, 16, 96, 192)
        self.p04 = PSPDec(128, 16, 72, 192)
        ...
        self.level2 = DownSamplerA(64, 64)
        self.level2_0 = DilatedParllelResidualBlockB1(64, 64)
        self.level2_1 = DilatedParllelResidualBlockB1(64, 64)

        self.p10 = PSPDec(192, 16, 80, 96)
        self.p20 = PSPDec(192, 16, 64, 96)
        self.p30 = PSPDec(192, 16, 48, 96)
        self.p40 = PSPDec(192, 16, 36, 96)
        ...
        self.level3_0 = DownSamplerA(128, 128)
        self.level3_1 = DilatedParllelResidualBlockB1(128, 128, 0.3)
        self.level3_2 = DilatedParllelResidualBlockB1(128, 128, 0.3)

        self.level4_1 = DilatedParllelResidualBlockB1(128, 128, 0.3)
        self.level4_2 = DilatedParllelResidualBlockB1(128, 128, 0.3)
        self.level4_3 = DilatedParllelResidualBlockB1(128, 128, 0.3)

        self.p1 = PSPDec(256, 64, 40, 48)
        self.p2 = PSPDec(256, 64, 32, 48)
        self.p3 = PSPDec(256, 64, 24, 48)
        self.p4 = PSPDec(256, 64, 18, 48)
